...
public class Eurhinosaurus extends WaterAnimal implements IAnimatable {
    ...
    public Eurhinosaurus(EntityType<? extends WaterAnimal> type, Level level) {
        super(type, level);
    ...
    protected SoundEvent getAmbientSound() {
        return PPRegistry.SoundReg.EURHINOSAURUS_AMBIENT.get();
    }

    @Nullable
    @Override
    protected SoundEvent getHurtSound(DamageSource pDamageSource) {
        return PPRegistry.SoundReg.EURHINOSAURUS_HURT.get();
    }

    @Nullable
    @Override
    protected SoundEvent getDeathSound() {
        return PPRegistry.SoundReg.EURHINOSAURUS_DEATH.get();
    }
    ...
    private PlayState handleAnimation(AnimationEvent<Eurhinosaurus> event) {
